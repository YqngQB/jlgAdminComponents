...
export default {
	...
	cellClassName: [
		String,
		Function
	] as PropType<VxeTablePropTypes.CellClassName>,
	// 给表头的行附加 className
	headerRowClassName: [
		String,
		Function
	] as PropType<VxeTablePropTypes.HeaderRowClassName>,
	// 给表头的单元格附加 className
	headerCellClassName: [
		String,
		Function
	...
	footerRowClassName: [
		String,
		Function
	] as PropType<VxeTablePropTypes.FooterRowClassName>,
	// 给表尾的单元格附加 className
	footerCellClassName: [
		String,
		Function
	] as PropType<VxeTablePropTypes.FooterCellClassName>,
	// 给单元格附加样式
	...
	headerCellStyle: [
		Object,
		Function
	] as PropType<VxeTablePropTypes.HeaderCellStyle>,
	// 给表尾单元格附加样式
	footerCellStyle: [
		Object,
		Function
	] as PropType<VxeTablePropTypes.FooterCellStyle>,
	// 给行附加样式
	...
	headerRowStyle: [
		Object,
		Function
	] as PropType<VxeTablePropTypes.HeaderRowStyle>,
	// 给表尾行附加样式
	footerRowStyle: [
		Object,
		Function
	] as PropType<VxeTablePropTypes.FooterRowStyle>,
	// 合并指定单元格
	...
	rowConfig: {
		...
		default: () => GlobalConfig.table.rowConfig
	},
	// 列调整配置项
